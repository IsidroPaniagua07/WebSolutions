const points = [
  {
    ...
    body: 'We know Henderson, Summerlin, the Strip corridor, and every micro-market in between. Your content and SEO will reflect it.',
    icon: (
  ...
  {
    title: 'Built for GLVAR MLS',
    body: 'Our IDX integration is pre-configured for the Greater Las Vegas Association of Realtors — no complicated setup required.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    body: 'Every client gets a monthly report showing traffic, lead volume, and search ranking improvements.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none">
    ...
    <section className="section" id="why-us">
      <div className="container why-grid">
        ...
        <div className="why-content">
          ...
          <h2 className="section-title-left">We Only Work With Las Vegas Realtors</h2>
          <p className="why-body">
            We&apos;re not a generalist agency trying to serve everyone. Our entire platform is built
            around the Greater Las Vegas real estate market — from Henderson to Summerlin, from
            North Las Vegas to Boulder City.
          </p>
